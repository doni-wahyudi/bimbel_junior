...
export default function HomePage() {
  return (
    <div className="home-page">
      <SEO
        title="Beranda"
        description="Bimbel Junior — Bimbingan belajar terpercaya untuk SD, SMP, dan SMA di Tanjung Priok, Jakarta Utara. Rating 4.9⭐, pengajar M.Pd., kelas kecil maks 10 siswa. Hubungi: 0812-1166-3711"
